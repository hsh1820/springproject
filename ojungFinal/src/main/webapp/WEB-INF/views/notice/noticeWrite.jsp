		...
		<div class="content-wrapper">
			...
			<section class="content">
				<div class="row">
					...
					<!-- form 태그 시작 -->
					<form class="col-md-12" method="POST" action="noticeWrite" enctype="multipart/form-data"
							...
							<div class="card card-outline card-primary">
								<div class="card-header">
									<div class="form-group row" style="margin-bottom: 0;">
										...
										<label for="inputTitle3" class="col-md-1 col-form-label" style="text-align: center;" style="margin-bottom: 0; height:200px;">첨부파일</label>
			                              <div class="col-md-11">
                ...
                information.</a>
									...
									<div class="float-right">
										...
										<a href="noticeList" class="btn primary">목록으로</a>
									</div>
								</div>
							</div>
						</div>
