...
<body class="hold-transition sidebar-mini">
   ...
   <div class="wrapper">
      ...
      <div class="content-wrapper">
         ...
         <!-- Main content -->
         <form class="form-horizontal" method="POST" action="insertNightMeal"
                     ...
                     <div class="col-md-10">
                        ...
                        <div class="card">
                           <div class="card-header bg-navy">
                              <h3 class="card-title">야근식대 작성</h3>
                           </div>
                        </div>
                        <div style="width: 95%;">
                           ...
                           <div class="card-body">
                              ...
                              <div class="form-group row">
                                 <label for="inputPassword3" class="col-md-2 col-form-label"
                                    style="text-align: center; width: 100%;">거래처 명</label>
                                 <div
                                    class="col-sm-4 align-items-center justify-content-between"
                                    style="text-align: center;">
                                    <input type="text" class="form-control" style="width: 300px;" name="docRemark"
                                       placeholder="음식점 명을 입력해주세요.">
                                 </div>

                                 <label for="inputPassword3" class="col-md-2 col-form-label" 
                                    style="text-align: center; width: 100%;">금액 입력</label>
                                 <div
                                    class="col-sm-4 align-items-center justify-content-between"
                                    style="text-align: center;">
                                    <input type="text" class="form-control" style="width: 300px;" name="docRemark"
                              ...
                              var arr = [];
                                 ...
                                 $("#makeLine").on("click",function(){
                                    ...
                                    var $li = $("<li>").prop
                                    ("class","list-group-item d-flex justify-content-between align-items-center").text(afterStr[1]);
                                    var $arrow =$("<i>").prop("class", "fas fa-angle-down fa-2x mt-2 mb-2 ml-5");
                              ...
                              <div>
                                 <button type="submit" class="btn btn-primary" onclick="test()"
                                    style="float: right; margin-right: 2%; width: 100px; height: 40px;"> 결재 등록 </button>
