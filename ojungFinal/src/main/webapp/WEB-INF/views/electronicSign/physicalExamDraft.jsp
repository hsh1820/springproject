...
<body class="hold-transition sidebar-mini">
   ...
   <div class="wrapper">
      ...
      <div class="content-wrapper">
         ...
         <!-- Main content -->
         <form class="form-horizontal" method="POST" action="insertPhysicalExam" onsubmit="return validate();"
                     ...
                     <div class="col-md-10">
                        ...
                        <div class="card">
                           <div class="card-header bg-navy">
                              <h3 class="card-title">건강검진신청서 작성</h3>
                           </div>
                        </div>
                        <div style="width: 95%;">
                              ...
                              <div class="form-group row">
                                 ...
                                 <div class="col-sm-10">
                                    <input type="text" class="form-control" name="docTitle"
                                       id="docTitle" placeholder="제목을 입력해주세요.">
                                 </div>
                              </div>
                              <!--                               <div class="form-group row">
 ...
 -->
                                       ...
                                       <div class="modal-dialog modal-lg"
                                          ...
                                          <div class="modal-content">
                                             ...
                                             <div class="modal-footer" style="padding-right: 50px;">
                                                ...
                                                <button id="makeLine" type="button" class="btn btn-outline-danger" data-dismiss="modal">결재라인
                                                   등록</button>
                                             </div>
                      ...
                      <div class="form-group row">
                        <label for="inputPassword3" class="col-sm-2 col-form-label" style="text-align: center;">진료 기관명</label>
                        <div class="col-sm-4">
                          <input class="mt-2 form-control" id="hospital" name="docRemark">
                        </div>
  
                        <label for="inputPassword3" class="col-sm-2 col-form-label" style="text-align: center;">병명</label>
                        <div class="col-sm-4">
                          <input class="mt-2 form-control" id="disease" name="docRemark">
                        </div>
                      </div>

                      <div class="form-group row">
                        <label for="inputPassword3" class="col-sm-2 col-form-label" style="text-align: center;">신청금액</label>
                        <div class="col-sm-4">
                          <input class="mt-2 form-control"  id="healthPrice" name="docRemark">
                        </div>
  
                        <label for="inputPassword3" class="col-sm-2 col-form-label" style="text-align: center;">본인 부담금</label>
                        <div class="col-sm-4">
                          <input class="mt-2 form-control"  id="copay" name="docRemark">
                        </div>
                      </div>
						...
						<input type="hidden" id="docRemark">
                              ...
                              var arr = [];
                                 ...
                                 function removeLine(){
                                     // 삭제 클릭시마다 선택한 요소 삭제하기 
                                      $("td[name=lineContent]").remove();
                                      $("span[name=group2]").remove();
                                   };
                                   $("#makeLine").on("click",function(){
                                      ...
                                      var $badge=$("<span>").prop("class", "badge badge-secondary badge-pill").text(BedgeName);
                                      $li.append($badge); 
                              ...
                              <table style="width: 100%;">
                                 <tr>
                                    <td colspan="3">&nbsp;&nbsp;</td>
                                    <td><textarea class="textarea" name="docContents" id="docContents"
...
<input type="hidden" style="display:none" name="docSignPath" id="docSignPath">
   ...
   <script type="text/javascript">
      ...
      function validate() {
          ...
          if ($("#hospital").val().trim().length == 0) {
             alert("진료 기관명을 입력해 주세요.");
             $("#hospital").focus();
             return false;
          }
          if ($("#disease").val().trim().length == 0) {
             alert("병명을 입력해 주세요.");
             $("#disease").focus();
             return false;
          }
          if ($("#healthPrice").val().trim().length == 0) {
             alert("신청금액 입력해 주세요.");
             $("#healthPrice").focus();
             return false;
          }
          if ($("#copay").val().trim().length == 0) {
             alert("본인부담금을 입력해 주세요.");
             $("#copay").focus();
             return false;
          }
          if(arr.length==0){
        ...
        $("#removeSelect").on("click", function(){ // 모달 - 취소버튼 누르면 그동안 선택한 값 초기화 하기
