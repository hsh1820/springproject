							...
							<div class="card-body" style="width: 100%; height: auto;">
								...
								<div class="row mt-5">
									...
									<div class="input-group mb-3 col-md-6">
										...
										<input type="text" class="form-control"
											value="${docList[0].dTitle}" style="background-color: white;"
											readonly>
									</div>
								</div>
								<!-- 첫 쨰 줄 끝-->
								...
								<div class="row">
									...
									<div class="input-group mb-3 col-md-6">
										...
										<input type="text" class="form-control"
											style="background-color: white;" value="${docList[0].store }"
											readonly>
									</div>
									...
									<div class="input-group mb-3 col-md-6">
										...
										<input type="text" class="form-control"
											style="background-color: white;" value="${docList[0].price }"
											readonly>
									</div>
								</div>
								<!-- 셋째 줄 끝-->
