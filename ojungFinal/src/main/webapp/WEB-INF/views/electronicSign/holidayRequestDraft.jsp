...
<body class="hold-transition sidebar-mini">
   ...
   <div class="wrapper">
      ...
      <div class="content-wrapper">
         ...
         <!-- Main content -->
         <form class="form-horizontal" method="POST" action="insertHolidayRequest"
                     ...
                     <div class="col-md-10">
                        ...
                        <div class="card">
                           <div class="card-header bg-navy">
                              <h3 class="card-title">휴가신청서 작성</h3>
                           </div>
                        </div>
                        <div style="width: 95%;">
 ...
 -->
                                       ...
                                       <div class="modal-dialog modal-lg"
                                          ...
                                          <div class="modal-content">
                                             ...
                                             <div class="modal-footer" style="padding-right: 50px;">
                                                ...
                                                <button type="button" class="btn btn-outline-secondary" id="removeSelect"
                             ...
                             <div class="form-group row">
								<label for="date" class="col-sm-2 col-form-label"
									style="text-align: center;">일자</label>
								<div class="col-sm-3">
									<input type="date" class="form-control" id="startDate" name="docRemark">
								</div>
								<p class="mt-2">
									<sub>부터</sub>
								</p>
								<div class="col-sm-3">
									<input type="date" class="form-control" id="endDate" name="docRemark">
								</div>
								<p class="mt-2"> <sub>까지</sub> </p>
								&nbsp;&nbsp;
								<p class="mt-2"> <sub>총 </sub> </p>
								&nbsp;
								<div>
									<input type="text" class="form-control" id="startDate" style="width: 50px;" maxlength="3" name="docRemark">
								</div>
								&nbsp;
								<p class="mt-2"> <sub>일</sub> </p>
							</div>
					...
					<div class="form-group row">
                      <label for="inputPassword3" class="col-md-2 col-form-label"
                        style="text-align: center;">휴가 종류</label>
                      <div class="col-md-4 ">
                        <select class="form-control" id="selectBox" name="docRemark">
                            <option value="" selected>휴가 종류를 선택해주세요</option>
                            ...
                            <option value="기타">기타</option>
                              ...
                              var arr = [];
                                 ...
                                 $("#selectBtn").click(function() {
                                                ...
                                                console.log("checkSignName : " + checkSignName);
                                                var index = $("#checkSignName option").index(
                                 ...
                                 // 화면상에는 보이지 않지만, 값이 남아있음.. + 모든 선택사항들이 지워져버림..
                                 function removeLine(){
                                 ...
                                 $("#makeLine").on("click",function(){
                                    ...
                                    var $badge=$("<span>").prop("class", "badge badge-secondary badge-pill").text(checkcheckName);
                                    $li.append($badge); 
				...
				<script>
					...
					for( var i=0; i<remark.length ; i++) {
                     ...
                     <div class="col-md-2 pl-3" id="lineDiv">
                           <div class="card row" >
                              <div class="card-header bg-navy">
                                 <h3 class="card-title">
      ...
      $(document).ready(function() {
		...
		function validate() {
			...
			if ($("#startDate").val().trim().length == 0) {
				alert("휴가 시작일을 입력해 주세요.");
				$("#startDate").focus();
				return false;
			}
			if ($("#endDate").val().trim().length == 0) {
				alert("휴가 종료일을 입력해 주세요.");
				$("#endDate").focus();
				return false;
			}
			if ($("#selectBox").val()=="") {
				//alert("휴가 종류를 선택해 주세요.");
				alert("휴가 종류를 선택해 주세요." + $("#selectBox").val());
				$("#selectBox").focus();
				return false;
			}
			...
			if($("#lines").hasClass("fa-angle-down")==false){
				alert("결재라인을 선택해 주세요.");
				return false;
				}
	      ...
	      function validate() {
	         ...
	         if ($("#docTitle").val().trim().length == 0) {
	            ...
	            console.log("docSignPath 1: " + $("#docSignPath").val());
	            console.log("docSignPath 2: " + $("#docSignPath").val().trim().length);
	            return false;
	         }
	         if ($("#startDate").val().trim().length == 0) {
	            alert("휴가 시작일을 입력해 주세요.");
