		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1>${deptBoard.deptName }게시판 작성</h1>
						</div>
						<div class="col-sm-6">
			...
			<section class="content">
				<div class="row">
					...
					<!-- form 태그 시작 -->
					<form class="col-md-12" method="POST" action="insert" role="form" enctype="multipart/form-data"
											...
											<div class="input-group">
												<div class="custom-file">
													<label class="custom-file-label" for="exampleInputFile">
														...
														id="exampleInputFile" name="deptBoardfile">
												</div>
											</div>
										</div>
									</div>
