 ...
 * Generated at: 2020-03-28 10:50:28 UTC
...
public final class departmentBoardInsert_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t<form class=\"col-md-12\" method=\"POST\" action=\"insert\" role=\"form\" enctype=\"multipart/form-data\"\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tname=\"title\" placeholder=\"제목을 입력해주세요\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<label for=\"inputTitle3\" class=\"col-md-1 col-form-label\" \n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"file\" class=\"custom-file-input\" multiple=\"multiple\"\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tid=\"exampleInputFile\" name=\"deptBoardfile\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\n");
