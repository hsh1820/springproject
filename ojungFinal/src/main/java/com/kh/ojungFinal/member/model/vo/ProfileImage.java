...
public class ProfileImage {
   ...
   public ProfileImage() {
	...
	public ProfileImage(String imageOriginName, String imageChangeName, String imagePath, int memberNo) {
		super();
	...
	public ProfileImage(int imageNo, String imageChangeName, int memberNo) {
		super();
	...
	public ProfileImage(int imageNo, String imageOriginName, String imageChangeName) {
		super();
		this.imageNo = imageNo;
		this.imageOriginName = imageOriginName;
		this.imageChangeName = imageChangeName;
	...
	public ProfileImage(String imageOriginName, String imageChangeName, String imagePath) {
		super();
		this.imageOriginName = imageOriginName;
		this.imageChangeName = imageChangeName;
		this.imagePath = imagePath;
